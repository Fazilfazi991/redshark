            ...
            <div className="container">
                <div className="about-grid">
                    <div className="about-content">
                        ...
                        <p>
                            Redsharc was born from a simple observation: traditional agencies often focus on billable hours rather than real client growth. Having worked with many companies and clients, we saw a recurring problem—clients would spend money without seeing meaningful results because no one was taking a truly focused, strategic approach. Many agencies don't fully understand each business or its market.
                        </p>
                        <p>
                            From this insight, we built Redsharc. Our mission is to deliver the right strategies that actually work for each business. We analyze your market, study competitors, and identify growth opportunities tailored to your unique needs.
                        </p>
                        <p>
                            With Redsharc, your business isn't just another client—it's a partner. By 2025, we aim to help businesses like yours achieve measurable growth and stronger market positions through focused, strategic execution.
                        </p>
                    </div>
