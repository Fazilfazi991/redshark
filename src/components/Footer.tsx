            ...
            <div className="container">
                <div className="footer-grid">
                    ...
                    <div className="footer-col">
                        <img src="/logo-brand.jpg" alt="Redsharc" style={{ height: '64px', width: 'auto', marginBottom: '16px' }} />
                ...
                <div className="footer-bottom">
                    <div className="copyright">© 2026 Redsharc Collective. All rights reserved.</div>
