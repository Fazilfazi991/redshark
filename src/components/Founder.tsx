            ...
            <div className="container">
                <div className="founder-wrapper">
                    <div className="founder-content">
                        <h2 className="section-title text-left">Hi, I'm Sreyas, founder of Redsharc.</h2>

                        <p className="founder-story">
                            I started Redsharc after watching the same problem repeat again and again.
                        </p>
                        ...
                        <h4 className="font-bold text-xl mb-3 text-white">Why I built Redsharc</h4>
                        <p className="founder-text">
                            Redsharc is my attempt to fix this.
                        </p>
                        ...
                        <div className="founder-sig">
                            ...
                            <div className="sig-role">Founder, Redsharc</div>
                        </div>
                    ...
                    <div className="founder-image-col">
                        <div className="founder-image-box">
                            <img src={founderImage} alt="Sreyas, Founder of Redsharc" className="founder-image" loading="lazy" />
                        </div>
                    </div>
                </div>
            </div>
