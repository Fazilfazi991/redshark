    ...
    content: [
        ...
        { type: 'paragraph', text: 'So, how do you pivot? Here is the checklist:' },
        {
            type: 'list', items: [
                ...
                'Build a Brand: When the chaotic winds of algorithm changes blow, Brand is the only shelter. If people search for you by name ("Redsharc SEO tips"), Google cannot hide you. Be the destination, not just a search result.'
            ]
        },
