...
export const paidAdsPost: BlogPost = {
    ...
    content: [
        ...
        { type: 'paragraph', text: 'The immediate reaction is to blame the platform. "Google Ads got too expensive." "Facebook targeting doesn\'t work since iOS14." Or you blame the agency. But having audited over $50M in ad spend here at [Redsharc](/contact), I can tell you: 9 times out of 10, the problem isn\'t the ad platform. It isn\'t the button color. It is the fundamental strategy. Here is exactly where your budget is leaking.' },
